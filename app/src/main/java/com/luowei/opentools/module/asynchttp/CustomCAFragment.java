 ...
 */
public class CustomCAFragment extends SampleParentFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            try {
                ...
                is = getResources().openRawResource(R.raw.asynchttp_store);
    ...
    private CharSequence getReadmeText() {
        String rtn = "";
        try {
            InputStream stream = getResources().openRawResource(R.raw.asynchttp_custom_ca);
    ...
    private void showCustomCAHelp() {
        ...
        builder.setTitle("Custom CA Example");
