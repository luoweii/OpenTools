 ...
 */
public class FilesFragment extends PostFragment {
    ...
    public RequestHandle executeSample(AsyncHttpClient client, String URL, Header[] headers, HttpEntity entity, ResponseHandlerInterface responseHandler) {
        try {
            ...
            return client.post(getContext(), URL, params, responseHandler);
    ...
    public File createTempFile(String namePart, int byteSize) {
        try {
            File f = File.createTempFile(namePart, "_handled", getContext().getCacheDir());
