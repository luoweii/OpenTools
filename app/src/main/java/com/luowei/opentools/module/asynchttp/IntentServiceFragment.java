 ...
 */
public class IntentServiceFragment extends SampleParentFragment{
    ...
    public void onStart() {
        ...
        getContext().registerReceiver(broadcastReceiver, iFilter);
    }
    ...
    public RequestHandle executeSample(AsyncHttpClient client, String URL, Header[] headers, HttpEntity entity, ResponseHandlerInterface responseHandler) {
        Intent serviceCall = new Intent(getContext(), ExampleIntentService.class);
        serviceCall.putExtra(ExampleIntentService.INTENT_URL, URL);
        getContext().startService(serviceCall);
        return null;
    }
}
