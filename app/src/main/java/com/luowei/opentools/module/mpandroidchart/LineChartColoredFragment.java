 ...
 */
public class LineChartColoredFragment extends BaseFragment {
    protected String[] mMonths = new String[] {
            "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dec"
    };

    @Bind({R.id.chart1,R.id.chart2,R.id.chart3,R.id.chart4})
    LineChart[] mCharts = new LineChart[4];
    private Typeface mTf;
    @Override
    public int getLayout() {
        return R.layout.mpa_fragment_colored_lines;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mTf = Typeface.createFromAsset(getContext().getAssets(), "OpenSans-Bold.ttf");
