 ...
 */
public class LineChartFragment extends BaseFragment implements SeekBar.OnSeekBarChangeListener,
...
//        mChart.invalidate();
    ...
    private void setData(int count, float range) {
        ...
        if (Utils.getSDKInt() >= 18) {
            ...
            Drawable drawable = ContextCompat.getDrawable(getContext(), R.drawable.mpa_fade_red);
