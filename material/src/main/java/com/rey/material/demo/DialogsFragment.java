...
public class DialogsFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.dialog_bt_title_only) {
        ...
        } else if (i == R.id.dialog_bt_msg_only) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
                @Override
                public void onPositiveActionClicked(DialogFragment fragment) {
        ...
        } else if (i == R.id.dialog_bt_title_msg) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
                @Override
                public void onPositiveActionClicked(DialogFragment fragment) {
        ...
        } else if (i == R.id.dialog_bt_custom) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
        ...
        } else if (i == R.id.dialog_bt_choice) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
                @Override
                public void onPositiveActionClicked(DialogFragment fragment) {
        ...
        } else if (i == R.id.dialog_bt_multi_choice) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
                @Override
                public void onPositiveActionClicked(DialogFragment fragment) {
