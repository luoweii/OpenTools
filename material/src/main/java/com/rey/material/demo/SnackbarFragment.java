		...
		View.OnClickListener listener = new View.OnClickListener() {
			...
			public void onClick(View v) {
				if(mSnackBar.getState() == SnackBar.STATE_SHOWN)
					...
					int i = v.getId();
					if (i == R.id.snackbar_bt_mobile_single) {
						mSnackBar.applyStyle(R.style.SnackBarSingleLine);
						mSnackBar.show();

					} else if (i == R.id.snackbar_bt_mobile_multi) {
						mSnackBar.applyStyle(R.style.SnackBarMultiLine);
						mSnackBar.show();

					} else if (i == R.id.snackbar_bt_tablet_single) {
					...
					} else if (i == R.id.snackbar_bt_tablet_multi) {
