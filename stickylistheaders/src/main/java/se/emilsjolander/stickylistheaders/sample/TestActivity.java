...
public class TestActivity extends ActionBarActivity implements
    ...
    CompoundButton.OnCheckedChangeListener checkBoxListener = new CompoundButton.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            if (i == R.id.sticky_checkBox) {
                stickyList.setAreHeadersSticky(isChecked);

            } else if (i == R.id.fade_checkBox) {
                fadeHeader = isChecked;

            } else if (i == R.id.draw_behind_checkBox) {
                stickyList.setDrawingListUnderStickyHeader(isChecked);

            } else if (i == R.id.fast_scroll_checkBox) {
    ...
    View.OnClickListener buttonListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            int i = view.getId();
            if (i == R.id.restore_button) {
                mAdapter.restore();

            } else if (i == R.id.update_button) {
                mAdapter.notifyDataSetChanged();

            } else if (i == R.id.clear_button) {
                mAdapter.clear();

            } else if (i == R.id.open_expandable_list_button) {
